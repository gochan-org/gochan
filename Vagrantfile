...
# if set to 1, an initial configuration will be created during provisioning, otherwise gochan-install will need to be run
INITCONFIG = ENV.fetch("GC_INITCONFIG", "") == "1"
