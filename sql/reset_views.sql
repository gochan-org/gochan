...
SELECT iba.id, ibaa.staff_id, username AS staff_username, iba.ip_ban_id, ibaa.appeal_text, ibaa.is_denied, ib.is_active as is_ban_active, ib.expires_at as ban_expires_at, ib.permanent as permanent, timestamp
