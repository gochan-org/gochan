...
})({"hWzny":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toTop", ()=>toTop);
parcelHelpers.export(exports, "toBottom", ()=>toBottom);
parcelHelpers.export(exports, "changePage", ()=>changePage);
/* global webroot, defaultStyle */ var _vars = require("./vars");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _boardevents = require("./boardevents");
...
function changePage(sel) {
    let info = (0, _postutil.getPageThread)();
...
(0, _jqueryDefault.default)(()=>{
    let pageThread = (0, _postutil.getPageThread)();
    let style = (0, _storage.getStorageVal)("style", defaultStyle);
    ...
    (0, _manage.initStaff)().then((0, _manage.createStaffMenu)).catch(()=>{
    // not logged in
    });
    (0, _watcher.initWatcher)();
    let passwordText = (0, _jqueryDefault.default)("input#postpassword").val();
    (0, _jqueryDefault.default)("input#delete-password").val(passwordText);
    if (pageThread.board != "") {
        (0, _postutil.prepareThumbnails)();
        if ((0, _storage.getBooleanStorageVal)("useqr", true)) (0, _qr.initQR)(pageThread);
        (0, _postutil.initPostPreviews)();
    }
    (0, _jqueryDefault.default)("div.post, div.reply").each((i, elem)=>{
        (0, _postutil.addPostDropdown)((0, _jqueryDefault.default)(elem));
    });
    (0, _jqueryDefault.default)(document).on("keydown", (0, _boardevents.handleKeydown));
});

},{"./vars":"jRdyc","jquery":"HtqFp","./boardevents":"crljo","./cookies":"l5c3u","./manage":"0yX8V","./postutil":"12NNr","./settings":"2blxl","./topbar":"cuSk6","./qr":"epotB","./watcher":"c0CZ6","./storage":"d8CBa","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"jRdyc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "downArrow", ()=>downArrow);
parcelHelpers.export(exports, "upArrow", ()=>upArrow);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
},{"jquery":"HtqFp","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"HtqFp":[function(require,module,exports) {
/*!
...
},{}],"crljo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleKeydown", ()=>handleKeydown);
parcelHelpers.export(exports, "applyBBCode", ()=>applyBBCode);
parcelHelpers.export(exports, "handleActions", ()=>handleActions);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _postutil = require("./postutil");
var _watcher = require("./watcher");
...
function handleKeydown(e) {
    ...
    if (!inForm && !e.ctrlKey) (0, _qr.openQR)();
    else if (isPostMsg && e.ctrlKey) applyBBCode(e);
}
function applyBBCode(e) {
    let tag = "";
    switch(e.keyCode){
        case 10:
        case 13:
    ...
    (0, _jqueryDefault.default)(ta).text(ta.value);
}
function handleActions(action, postIDStr) {
    let idArr = idRe.exec(postIDStr);
    if (!idArr) return;
    let postID = idArr[4];
    let board = (0, _postutil.currentBoard)();
    switch(action){
        case "Watch thread":
            (0, _watcher.watchThread)(postID, board);
            break;
        case "Unwatch thread":
            (0, _watcher.unwatchThread)(postID, board);
            break;
        /* case "Show/hide thread":
		case "Show/hide post":
			console.log(`Showing/hiding ${postID}`);
			hidePost(postID);
			break; */ case "Edit post":
            (0, _postutil.editPost)(postID, board);
            break;
        case "Report post":
            (0, _postutil.reportPost)(postID, board);
            break;
        case "Delete file":
            (0, _postutil.deletePost)(postID, board, true);
            break;
        case "Delete thread":
        case "Delete post":
            (0, _postutil.deletePost)(postID, board);
            break;
    }
}

},{"jquery":"HtqFp","./postutil":"12NNr","./watcher":"c0CZ6","./qr":"epotB","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"12NNr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPageThread", ()=>getPageThread);
parcelHelpers.export(exports, "getUploadPostID", ()=>getUploadPostID);
parcelHelpers.export(exports, "currentBoard", ()=>currentBoard);
parcelHelpers.export(exports, "currentThread", ()=>currentThread);
...
} */ parcelHelpers.export(exports, "insideOP", ()=>insideOP);
parcelHelpers.export(exports, "updateThreadJSON", ()=>updateThreadJSON);
parcelHelpers.export(exports, "updateThread", ()=>updateThread);
parcelHelpers.export(exports, "initPostPreviews", ()=>initPostPreviews);
parcelHelpers.export(exports, "prepareThumbnails", ()=>prepareThumbnails);
parcelHelpers.export(exports, "quote", ()=>quote);
parcelHelpers.export(exports, "addPostDropdown", ()=>addPostDropdown);
parcelHelpers.export(exports, "editPost", ()=>editPost);
parcelHelpers.export(exports, "reportPost", ()=>reportPost);
parcelHelpers.export(exports, "deletePost", ()=>deletePost);
parcelHelpers.export(exports, "getThreadJSON", ()=>getThreadJSON);
/* global webroot */ /**
...
/** @type {BoardThread} */ let currentThreadJSON = {
    posts: []
};
function getPageThread() {
    ...
    if (arr.board != "") info.boardID = (0, _jqueryDefault.default)("form#postform input[name=boardid]").val() - 1;
    return info;
}
function getUploadPostID(upload, container) {
    // if container, upload is div.upload-container
    // otherwise it's img or video
    let jqu = container ? (0, _jqueryDefault.default)(upload) : (0, _jqueryDefault.default)(upload).parent();
    return insideOP(jqu) ? jqu.siblings().eq(4).text() : jqu.siblings().eq(3).text();
}
function currentBoard() {
    let board = (0, _jqueryDefault.default)("form#main-form input[type=hidden][name=board]").val();
...
function currentThread() {
    ...
    if (splits.length != 4) return thread;
    let reArr = threadRE.exec(splits[3]);
    if (reArr.length > 0) thread.thread = reArr[0];
    return thread;
}
function insideOP(elem) {
    return (0, _jqueryDefault.default)(elem).parents("div.op-post").length > 0;
}
/**
 ...
 */ function formatFileSize(size) {
    ...
    else if (size <= 100000) return `${(size / 1024).toFixed(1)} KB`;
    else if (size <= 100000000) return `${(size / 1024 / 1024).toFixed(2)} MB`;
 ...
 */ function createPostElement(post, boardDir, elementClass = "inlinepostprev") {
    let $post = (0, _jqueryDefault.default)("<div/>").prop({
        class: elementClass
    });
    $post.append((0, _jqueryDefault.default)("<a/>").prop({
        id: post.no.toString(),
        class: "anchor"
    }), (0, _jqueryDefault.default)("<input/>").prop({
        type: "checkbox",
        id: `check${post.no}`,
        name: `check${post.no}`
    }), (0, _jqueryDefault.default)("<label/>").prop({
        class: "post-info",
        for: `check${post.no}`
    }).append(formatDateString(post.time)), " ", (0, _jqueryDefault.default)("<a/>").prop({
        href: webroot + boardDir + "/res/" + (post.resto > 0 ? post.resto : post.no) + ".html#" + post.no
    }).text("No."), " ", (0, _jqueryDefault.default)("<a/>").prop({
    ...
    let $postName = (0, _jqueryDefault.default)("<span/>").prop({
        class: "postername"
    });
    if (post.email == "") $postName.text(postName);
    else $postName.append((0, _jqueryDefault.default)("<a/>").prop({
        href: "mailto:" + post.email
    }).text(post.name));
    $postInfo.prepend($postName);
    if (post.trip != "") $postInfo.prepend($postName, (0, _jqueryDefault.default)("<span/>").prop({
        class: "tripcode"
    }).text("!" + post.trip), " ");
    else $postInfo.prepend($postName, " ");
    if (post.sub != "") $postInfo.prepend((0, _jqueryDefault.default)("<span/>").prop({
        class: "subject"
    }).text(post.sub), " ");
    if (post.filename != "" && post.filename != "deleted") {
        let thumbFile = getThumbFilename(post.tim);
        $post.append((0, _jqueryDefault.default)("<div/>").prop({
            class: "file-info"
        }).append("File: ", (0, _jqueryDefault.default)("<a/>").prop({
            href: webroot + boardDir + "/src/" + post.tim,
            target: "_blank"
        }).text(post.tim), ` - (${formatFileSize(post.fsize)} , ${post.w}x${post.h}, `, (0, _jqueryDefault.default)("<a/>").prop({
            class: "file-orig",
            href: webroot + boardDir + "/src/" + post.tim,
            download: post.filename
        }).text(post.filename), ")"), (0, _jqueryDefault.default)("<a/>").prop({
            class: "upload-container",
            href: webroot + boardDir + "/src/" + post.tim
        }).append((0, _jqueryDefault.default)("<img/>").prop({
            class: "upload",
...
function updateThreadHTML() {
    ...
    for (const post of currentThreadJSON.posts){
        let selector = "";
        if (post.resto == 0) selector += `div#${post.no}.thread`;
        else selector += `a#${post.no}.anchor`;
        let elementExists = (0, _jqueryDefault.default)(selector).length > 0;
        if (elementExists) continue; // TODO: check for edits
        let $replyContainer = (0, _jqueryDefault.default)("<div/>").prop({
            id: `replycontainer${post.no}`,
            class: "reply-container"
        }).append(createPostElement(post, thread.board, "reply"));
...
function createPostPreview(e, $post, inline = true) {
    ...
    $preview.prop({
        class: "inlinepostprev"
    }).find("div.inlinepostprev").remove().find("a.postref").on("click", expandPost);
    if (inline) $preview.insertAfter(e.target);
...
function expandPost(e) {
    ...
    let $next = (0, _jqueryDefault.default)(e.target).next();
    ...
    let $post = (0, _jqueryDefault.default)(`div#op${postID}, div#reply${postID}`).first();
    if ($post.length > 0) {
        let $preview = createPostPreview(e, $post, e.type == "click");
        if (e.type == "mouseenter") {
            $hoverPreview = $preview.insertAfter(e.target);
            (0, _jqueryDefault.default)(document.body).on("mousemove", previewMoveHandler);
        }
        return;
    }
    if (e.type == "click") (0, _jqueryDefault.default).get(href, (data)=>{
        $post = (0, _jqueryDefault.default)(data).find(`div#op${postID}, div#reply${postID}`).first();
        if ($post.length < 1) return; // post not on this page.
        createPostPreview(e, $post, true);
    }).catch((t, u, v)=>{
        (0, _lightbox.alertLightbox)(v, "Error");
        return;
    });
}
function initPostPreviews($post = null) {
    if (getPageThread().board == "" && $post === null) return;
    doClickPreview = (0, _storage.getBooleanStorageVal)("enablepostclick", true);
    doHoverPreview = (0, _storage.getBooleanStorageVal)("enableposthover", false);
    let $refs = null;
    $refs = $post === null ? (0, _jqueryDefault.default)("a.postref") : $post.find("a.postref");
    if (doClickPreview) $refs.on("click", expandPost);
    else $refs.off("click", expandPost);
    if (doHoverPreview) $refs.on("mouseenter", expandPost).on("mouseleave", ()=>{
        if ($hoverPreview !== null) $hoverPreview.remove();
        $hoverPreview = null;
        (0, _jqueryDefault.default)(document.body).off("mousemove", previewMoveHandler);
    });
    else $refs.off("mouseenter").off("mouseleave").off("mousemove");
}
function prepareThumbnails() {
    // set thumbnails to expand when clicked
    (0, _jqueryDefault.default)("a.upload-container").on("click", function(e) {
        e.preventDefault();
        let a = (0, _jqueryDefault.default)(this);
        ...
        if (videoTestRE.test(thumbURL + uploadURL)) {
            // Upload is a video
            thumb.hide();
            var video = (0, _jqueryDefault.default)("<video />").prop({
                src: uploadURL,
                autoplay: true,
                controls: true,
                class: "upload",
            ...
            fileInfoElement.append((0, _jqueryDefault.default)("<a />").prop("href", "javascript:;").on("click", function() {
                video.remove();
                thumb.show();
                this.remove();
                thumb.prop({
...
function quote(no) {
    if ((0, _storage.getBooleanStorageVal)("useqr", true)) (0, _qr.openQR)();
    let msgboxID = "postmsg";
    let msgbox = document.getElementById("qr" + msgboxID);
    if (msgbox == null) msgbox = document.getElementById(msgboxID);
    let selected = selectedText();
    let lines = selected.split("\n");
    if (selected != "") for(const l in lines)lines[l] = ">" + lines[l];
    ...
    if (msgbox.id == "postmsg") window.scroll(0, msgbox.offsetTop - 48);
    msgbox.focus();
}
window.quote = quote;
function addPostDropdown($post) {
    if ($post.find("select.post-actions").length > 0) return $post;
    let $postInfo = $post.find("label.post-info");
    ...
    let $ddownMenu = (0, _jqueryDefault.default)("<select />", {
        class: "post-actions",
        id: postID
    }).append("<option disabled selected>Actions</option>");
    if (isOP) {
        let threadID = idRe.exec(postID)[4];
        if ((0, _watcher.isThreadWatched)(threadID, currentBoard())) $ddownMenu.append("<option>Unwatch thread</option>");
        else $ddownMenu.append("<option>Watch thread</option>");
    }
    $ddownMenu.append(// `<option>Show/hide ${threadPost}</option>`,
    `<option>Edit post</option>`, `<option>Report post</option>`, `<option>Delete ${threadPost}</option>`).insertAfter($postInfo).on("click", (event)=>{
        if (event.target.nodeName != "OPTION") return;
        (0, _boardevents.handleActions)($ddownMenu.val(), postID);
    });
    if (hasUpload) $ddownMenu.append(`<option>Delete file</option>`);
    return $post;
}
function editPost(id, board) {
    let cookiePass = (0, _cookies.getCookie)("password");
    (0, _lightbox.promptLightbox)(cookiePass, true, ()=>{
        (0, _jqueryDefault.default)("input[type=checkbox]").prop("checked", false);
        (0, _jqueryDefault.default)(`input#check${id}`).prop("checked", true);
        (0, _jqueryDefault.default)("input[name=edit_btn]").trigger("click");
    }, "Edit post");
}
function reportPost(id, board) {
    (0, _lightbox.promptLightbox)("", false, ($lb, reason)=>{
        ...
        (0, _jqueryDefault.default).post(webroot + "util", xhrFields).fail((data)=>{
            let errStr = data.error;
            if (errStr == undefined) errStr = data.statusText;
            (0, _lightbox.alertLightbox)(`Report failed: ${errStr}`, "Error");
        }).done(()=>{
            (0, _lightbox.alertLightbox)("Report sent", "Success");
        }, "json");
    }, "Report post");
}
window.reportPost = reportPost;
function deletePostFile(id) {
    let $elem = (0, _jqueryDefault.default)(`div#op${id}.op-post`);
    (0, _lightbox.alertLightbox)("File deleted", "Success");
...
function deletePostElement(id) {
    ...
    if ($elem.length > 0) {
        ...
        $elem.parent().remove();
    } else (0, _jqueryDefault.default)(`div#replycontainer${id}`).remove();
}
function deletePost(id, board, fileOnly) {
    let cookiePass = (0, _cookies.getCookie)("password");
    (0, _lightbox.promptLightbox)(cookiePass, true, ($lb, password)=>{
        let xhrFields = {
            board: board,
            boardid: (0, _jqueryDefault.default)("input[name=boardid]").val(),
            delete_btn: "Delete",
            password: password,
            json: "1"
        };
        xhrFields[`check${id}`] = "on";
        if (fileOnly) xhrFields.fileonly = "on";
        (0, _jqueryDefault.default).post(webroot + "util", xhrFields).fail((data)=>{
            data;
            (0, _lightbox.alertLightbox)(`Delete failed: ${data.error}`, "Error");
        }).done((data)=>{
            if (data.error == undefined || data == "") {
                if (location.href.indexOf(`/${board}/res/${id}.html`) > -1) (0, _lightbox.alertLightbox)("Thread deleted", "Success");
                else if (fileOnly) deletePostFile(id);
                else deletePostElement(id);
            } else {
                if (data.boardid == 0 && data.postid == 0) (0, _lightbox.alertLightbox)(`Error deleting post #${id}: Post doesn't exist`, "Error");
                else if (data !== "") {
                    (0, _lightbox.alertLightbox)(`Error deleting post #${id}`, "Error");
                    console.log(data);
                }
            }
        }, "json");
...
function getThreadJSON(threadID, board) {
    return (0, _jqueryDefault.default).ajax({
...
(0, _jqueryDefault.default)(()=>{
    ...
    threadWatcherInterval = setInterval(updateThread, (0, _storage.getNumberStorageVal)("watcherseconds", 10) * 1000);
});

},{"jquery":"HtqFp","./cookies":"l5c3u","./lightbox":"jncT6","./storage":"d8CBa","./boardevents":"crljo","./watcher":"c0CZ6","./qr":"epotB","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"l5c3u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * @param {string} name
 */ parcelHelpers.export(exports, "getCookie", ()=>getCookie);
parcelHelpers.export(exports, "getNumberCookie", ()=>getNumberCookie);
parcelHelpers.export(exports, "getBooleanCookie", ()=>getBooleanCookie);
/**
 * gets cookies ready to be used elsewhere
 */ parcelHelpers.export(exports, "initCookies", ()=>initCookies);
/**
 * Set a cookie
 * @param {string} name
 * @param {string} value
...
/* global webroot */ var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
function getNumberCookie(name, defaultVal = "0") {
    return parseFloat(getCookie(name, defaultVal));
}
function getBooleanCookie(name, defaultVal = "true") {
    return getCookie(name, defaultVal) == "true";
}
function randomPassword(len = 8) {
    const validChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!#$%&'*+-.^_`|~";
    let pass = "";
    for(let p = 0; p < len; p++)pass += validChars[Math.floor(Math.random() * validChars.length)];
    return pass;
}
function initCookies() {
    ...
    (0, _jqueryDefault.default)("input[name=postname]").val(getCookie("name"));
    (0, _jqueryDefault.default)("input[name=postemail]").val(getCookie("email"));
    (0, _jqueryDefault.default)("input[name=postpassword]").val(pwCookie);
    (0, _jqueryDefault.default)("input[name=delete-password]").val(pwCookie);
}
function setCookie(name, value, expires, root) {
    if (root === undefined || root === "") root = webroot;
    let expiresStr = "";
    if (expires !== undefined && expires !== "") {
        expiresStr = ";expires=";
        let d = new Date();
        d.setTime(d.getTime() + 86400000 * expires);
        expiresStr += d.toUTCString();
    }
    document.cookie = `${name}=${value}${expiresStr};path=${root};sameSite=strict`;
}

},{"jquery":"HtqFp","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"jncT6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "removeLightbox", ()=>removeLightbox);
parcelHelpers.export(exports, "showLightBox", ()=>showLightBox);
parcelHelpers.export(exports, "promptLightbox", ()=>promptLightbox);
parcelHelpers.export(exports, "alertLightbox", ()=>alertLightbox);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const emptyFunc = ()=>{};
function removeLightbox(...customs) {
    (0, _jqueryDefault.default)(".lightbox, .lightbox-bg").remove();
    for (const custom of customs)(0, _jqueryDefault.default)(custom).remove();
}
function showLightBox(title, innerHTML) {
    (0, _jqueryDefault.default)(document.body).prepend(`<div class="lightbox-bg"></div><div class="lightbox"><div class="lightbox-title">${title}<a href="javascript:;" class="lightbox-x">X</a><hr /></div>${innerHTML}</div>`);
    (0, _jqueryDefault.default)("a.lightbox-x, .lightbox-bg").on("click", removeLightbox);
}
function simpleLightbox(properties = {}, customCSS = {}, $elements = []) {
    if (properties["class"] === undefined) properties["class"] = "lightbox";
    let defaultCSS = {
    ...
    for(const key in defaultCSS)if (customCSS[key] === undefined) customCSS[key] = defaultCSS[key];
    let $box = (0, _jqueryDefault.default)("<div/>").prop(properties).css(customCSS).prependTo(document.body).append($elements);
    (0, _jqueryDefault.default)("<div />").prop({
        class: "lightbox-bg"
    }).on("click", function() {
        removeLightbox(this);
...
function promptLightbox(defVal = "", isMasked = false, onOk = emptyFunc, title = "") {
    let $ok = (0, _jqueryDefault.default)("<button/>").prop({
        "id": "okbutton"
    }).text("OK");
    let $cancel = (0, _jqueryDefault.default)("<button/>").prop({
        "id": "cancelbutton"
    }).text("Cancel");
    let val = typeof defVal == "string" ? defVal : "";
    let $promptInput = (0, _jqueryDefault.default)("<input/>").prop({
        id: "promptinput",
        type: isMasked ? "password" : "text"
    }).val(val);
    let $form = (0, _jqueryDefault.default)("<form/>").prop({
        "action": "javascript:;",
        "autocomplete": "off"
    }).append((0, _jqueryDefault.default)("<b/>").text(title), $promptInput, "<br/><br/>", $ok, $cancel);
    let $lb = simpleLightbox({}, {}, [
        $form
    ]);
    $promptInput.trigger("focus");
    $ok.on("click", function() {
        if (onOk($lb, $promptInput.val()) == false) return;
...
function alertLightbox(msg = "", title = location.hostname, onOk = emptyFunc) {
    let $ok = (0, _jqueryDefault.default)("<button/>").prop({
        "id": "okbutton"
    }).text("OK");
    let $lb = simpleLightbox({}, {}, [
        (0, _jqueryDefault.default)("<b/>").prop({
            id: "alertTitle"
        }).text(title),
        "<hr/>",
        (0, _jqueryDefault.default)("<span/>").prop({
            id: "alertText"
        }).text(msg),
        "<br/>",
        $ok
...
},{"jquery":"HtqFp","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"d8CBa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getStorageVal", ()=>getStorageVal);
parcelHelpers.export(exports, "getBooleanStorageVal", ()=>getBooleanStorageVal);
parcelHelpers.export(exports, "getNumberStorageVal", ()=>getNumberStorageVal);
parcelHelpers.export(exports, "getJsonStorageVal", ()=>getJsonStorageVal);
parcelHelpers.export(exports, "setStorageVal", ()=>setStorageVal);
var _cookies = require("./cookies");
function getStorageVal(key, defaultVal = "") {
    if (localStorage == undefined) return (0, _cookies.getCookie)(key, defaultVal);
    let val = localStorage.getItem(key);
    if (val === null) return defaultVal;
    return val;
}
function getBooleanStorageVal(key, defaultVal = false) {
    let val = getStorageVal(key, defaultVal);
    return val == true || val == "true";
}
function getNumberStorageVal(key, defaultVal = 0) {
    return Number.parseFloat(getStorageVal(key, defaultVal));
}
function getJsonStorageVal(key, defaultVal) {
    let val = defaultVal;
    try {
...
function setStorageVal(key, val) {
    if (localStorage == undefined) (0, _cookies.setCookie)(key, val);
    else localStorage.setItem(key, val);
}

},{"./cookies":"l5c3u","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"c0CZ6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getWatchedThreads", ()=>getWatchedThreads);
parcelHelpers.export(exports, "isThreadWatched", ()=>isThreadWatched);
parcelHelpers.export(exports, "watchThread", ()=>watchThread);
parcelHelpers.export(exports, "unwatchThread", ()=>unwatchThread);
parcelHelpers.export(exports, "initWatcher", ()=>initWatcher);
var _postutil = require("./postutil");
var _storage = require("./storage");
let watching = false;
...
function getWatchedThreads() {
    ...
    let watched = (0, _storage.getJsonStorageVal)("watched", {});
...
function isThreadWatched(threadID, board) {
    let watched = (0, _storage.getJsonStorageVal)("watched", {});
...
function watchThread(threadID, board) {
    let watched = (0, _storage.getJsonStorageVal)("watched", {});
    if (!(watched[board] instanceof Array)) watched[board] = [];
    ...
    (0, _storage.setStorageVal)("watched", JSON.stringify(watched));
/* getThreadJSON(threadID, board).then(data => {

	}); */ }
function unwatchThread(threadID, board) {
    let watched = (0, _storage.getJsonStorageVal)("watched", {});
    if (!(watched[board] instanceof Array)) return;
    for(const i in watched[board])if (watched[board][i].id == threadID) {
...
function initWatcher() {
    let watched = (0, _storage.getJsonStorageVal)("watched", {});
    if (watcherInterval > -1) clearInterval(watcherInterval);
    let board = (0, _postutil.currentBoard)();
    watching = watched !== null && watched[board] instanceof Array;
    if (watching) {
        getWatchedThreads();
        watcherInterval = setInterval(getWatchedThreads, (0, _storage.getNumberStorageVal)("watcherseconds", 10) * 1000);
    }
}

},{"./postutil":"12NNr","./storage":"d8CBa","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"epotB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "$qr", ()=>$qr);
parcelHelpers.export(exports, "initQR", ()=>initQR);
parcelHelpers.export(exports, "openQR", ()=>openQR);
parcelHelpers.export(exports, "closeQR", ()=>closeQR);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _version = require("jquery-ui/ui/version");
var _plugin = require("jquery-ui/ui/plugin");
var _safeActiveElement = require("jquery-ui/ui/safe-active-element");
var _widget = require("jquery-ui/ui/widget");
var _scrollParent = require("jquery-ui/ui/scroll-parent");
var _mouse = require("jquery-ui/ui/widgets/mouse");
var _safeBlur = require("jquery-ui/ui/safe-blur");
var _draggable = require("jquery-ui/ui/widgets/draggable");
...
var _postutil = require("./postutil");
let $qr = null;
const qrButtonHTML = `<input type="file" id="imagefile" name="imagefile" style="display: none;" />` + `<input name="imagefilebtn" type="button" onclick="document.getElementById('imagefile').click();" value="Browse...">` + `<input type="submit" value="Post" style="float:right;"/>`;
const qrTitleBar = `<div id="qr-title">` + `<span id="qr-message"></span>` + `<span id="qr-buttons"><a href="javascript:toBottom();">${0, _vars.downArrow}</a>` + `<a href="javascript:toTop();">${0, _vars.upArrow}</a><a href="javascript:closeQR();">X</a></span></div>`;
function initQR(pageThread) {
    if ($qr !== null) // QR box already initialized
    return;
    let onPostingPage = (0, _jqueryDefault.default)("form input[name=boardid]").length > 0;
    // don't open the QR box if we aren't on a board or thread page
    if (!onPostingPage) return;
    const nameCookie = (0, _cookies.getCookie)("name");
    const emailCookie = (0, _cookies.getCookie)("email");
    let $qrbuttons = (0, _jqueryDefault.default)("<div/>").prop("id", "qrbuttons").append(qrButtonHTML);
    let $postform = (0, _jqueryDefault.default)("<form/>").prop({
        id: "qrpostform",
        name: "qrpostform",
        action: "/post",
        method: "POST",
        enctype: "multipart/form-data"
    }).append((0, _jqueryDefault.default)("<input/>").prop({
        type: "hidden",
        name: "threadid",
        value: pageThread.op
    }), (0, _jqueryDefault.default)("<input/>").prop({
        ...
        name: "boardid",
        value: 1
    }), (0, _jqueryDefault.default)("<div/>").append((0, _jqueryDefault.default)("<input/>").prop({
        id: "qrpostname",
        type: "text",
        name: "postname",
        value: nameCookie,
        ...
        name: "postsubject",
        placeholder: "Subject"
    })), (0, _jqueryDefault.default)("<div/>").append((0, _jqueryDefault.default)("<textarea/>").prop({
        id: "qrpostmsg",
        name: "postmsg",
        placeholder: "Message"
    })), $qrbuttons);
    let qrTop = 32;
    let pintopbar = (0, _storage.getBooleanStorageVal)("pintopbar", true);
    if (pintopbar) qrTop = (0, _topbar.$topbar).outerHeight() + 16;
    let qrPos = (0, _storage.getJsonStorageVal)("qrpos", {
        top: qrTop,
        left: 16
    });
    if (!(qrPos.top > -1)) qrPos.top = qrTop;
    if (!(qrPos.left > -1)) qrPos.left = 16;
    $qr = (0, _jqueryDefault.default)("<div />").prop({
        id: "qr-box"
    }).css({
        top: qrPos.top,
        left: qrPos.left,
        position: "fixed"
    }).append((0, _jqueryDefault.default)(qrTitleBar), $postform).draggable({
        handle: "div#qr-title",
        scroll: false,
        containment: "window",
        drag: (event, ui)=>{
            ui.position.top = Math.max(ui.position.top, (0, _topbar.topbarHeight));
            (0, _storage.setStorageVal)("qrpos", JSON.stringify(ui.position));
        }
    });
    openQR();
    if ((0, _postutil.currentThread)().thread < 1) return;
    (0, _jqueryDefault.default)("form#qrpostform").on("submit", function(e) {
        let $form = (0, _jqueryDefault.default)(this);
        e.preventDefault();
        (0, _jqueryDefault.default).ajax({
            ...
            data: $form.serialize(),
            success: (data)=>{
                (0, _postutil.updateThread)().then(clearQR).then(()=>{
                    let persist = (0, _storage.getBooleanStorageVal)("persistentqr", false);
                    if (!persist) closeQR();
                });
            }
        });
...
},{"jquery":"HtqFp","jquery-ui/ui/version":"fVqA8","jquery-ui/ui/plugin":"fZ2wP","jquery-ui/ui/safe-active-element":"7xomF","jquery-ui/ui/widget":"9C6CL","jquery-ui/ui/scroll-parent":"eYs5Z","jquery-ui/ui/widgets/mouse":"dH1Qr","jquery-ui/ui/safe-blur":"2AeOo","jquery-ui/ui/widgets/draggable":"65XDI","./vars":"jRdyc","./cookies":"l5c3u","./topbar":"cuSk6","./storage":"d8CBa","./postutil":"12NNr","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"fVqA8":[function(require,module,exports) {
(function(factory) {
    "use strict";
...
},{}],"fZ2wP":[function(require,module,exports) {
(function(factory) {
    "use strict";
    if (typeof define === "function" && define.amd) // AMD. Register as an anonymous module.
    define([
...
},{}],"7xomF":[function(require,module,exports) {
(function(factory) {
    "use strict";
    if (typeof define === "function" && define.amd) // AMD. Register as an anonymous module.
    define([
...
},{}],"9C6CL":[function(require,module,exports) {
/*!
...
},{}],"eYs5Z":[function(require,module,exports) {
/*!
...
},{}],"dH1Qr":[function(require,module,exports) {
/*!
...
(function(factory) {
    ...
    return $.widget("ui.mouse", {
        ...
        _mouseDown: function(event1) {
            // don't let more than one widget handle mouseStart
            if (mouseHandled) return;
            this._mouseMoved = false;
            // We may have missed mouseup (out of window)
            if (this._mouseStarted) this._mouseUp(event1);
            this._mouseDownEvent = event1;
            var that = this, btnIsLeft = event1.which === 1, // event.target.nodeName works around a bug in IE 8 with
            // disabled inputs (#7620)
            elIsCancel = typeof this.options.cancel === "string" && event1.target.nodeName ? $(event1.target).closest(this.options.cancel).length : false;
            if (!btnIsLeft || elIsCancel || !this._mouseCapture(event1)) return true;
            this.mouseDelayMet = !this.options.delay;
            if (!this.mouseDelayMet) this._mouseDelayTimer = setTimeout(function() {
                that.mouseDelayMet = true;
            }, this.options.delay);
            if (this._mouseDistanceMet(event1) && this._mouseDelayMet(event1)) {
                this._mouseStarted = this._mouseStart(event1) !== false;
            ...
            if (true === $.data(event1.target, this.widgetName + ".preventClickEvent")) $.removeData(event1.target, this.widgetName + ".preventClickEvent");
...
},{}],"2AeOo":[function(require,module,exports) {
(function(factory) {
    "use strict";
    if (typeof define === "function" && define.amd) // AMD. Register as an anonymous module.
    define([
...
},{}],"65XDI":[function(require,module,exports) {
/*!
...
},{}],"cuSk6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "$topbar", ()=>$topbar);
parcelHelpers.export(exports, "topbarHeight", ()=>topbarHeight);
/**
 * TopBarButton A button to be added to the right side of the top bar
 */ parcelHelpers.export(exports, "TopBarButton", ()=>TopBarButton);
/**
 * Initialize the bar at the top of the page with board links and buttons
 */ parcelHelpers.export(exports, "initTopBar", ()=>initTopBar);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _storage = require("./storage");
let $topbar = null;
...
class TopBarButton {
	 ...
	 */ constructor(title, action = ()=>{}){
        ...
        this.button = (0, _jqueryDefault.default)("<a/>").prop({
            "href": "javascript:;",
...
function initTopBar() {
    $topbar = (0, _jqueryDefault.default)("div#topbar");
    if ((0, _storage.getBooleanStorageVal)("pintopbar", true)) $topbar.css({
        "z-index": "9001",
        "position": "fixed"
    });
    else $topbar.css({
...
},{"jquery":"HtqFp","./storage":"d8CBa","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"0yX8V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "staffActions", ()=>staffActions);
parcelHelpers.export(exports, "staffInfo", ()=>staffInfo);
parcelHelpers.export(exports, "initStaff", ()=>initStaff);
parcelHelpers.export(exports, "getStaffInfo", ()=>getStaffInfo);
parcelHelpers.export(exports, "isLoggedIn", ()=>isLoggedIn);
parcelHelpers.export(exports, "banSelectedPost", ()=>banSelectedPost);
/**
 ...
 */ parcelHelpers.export(exports, "createStaffMenu", ()=>createStaffMenu);
/* global webroot */ var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _lightbox = require("./lightbox");
var _topbar = require("./topbar");
...
async function getStaffInfo() {
    if (loginChecked) // don't make multiple unnecessary AJAX requests if we're already logged in
    return staffInfo;
    loginChecked = true;
    return (0, _jqueryDefault.default).ajax({
        method: "GET",
        ...
        if (info.error) return notAStaff;
        staffInfo = info;
        return info;
    });
}
...
function banSelectedPost() {
    ...
    let checks = (0, _jqueryDefault.default)("input[type=checkbox]");
    if (checks.length == 0) {
        (0, _lightbox.alertLightbox)("No posts selected");
        return false;
    }
    let postID = 0;
    for(let i = 0; i < checks.length; i++)if (checks[i].id.indexOf("check") == 0) {
 ...
 */ function menuItem(action, isCategory = false) {
    return isCategory ? (0, _jqueryDefault.default)("<div/>").append((0, _jqueryDefault.default)("<b/>").text(action)) : (0, _jqueryDefault.default)("<div/>").append((0, _jqueryDefault.default)("<a/>").prop({
 ...
 */ function filterAction(action, perms) {
    return action.title != "Logout" && action.title != "Dashboard" && action.jsonOutput < 2 && action.perms == perms;
}
function createStaffMenu(staff = staffInfo) {
    let rank = staff.Rank;
    if (rank == 0) return;
    $staffMenu = (0, _jqueryDefault.default)("<div/>").prop({
        id: "staffmenu",
        class: "dropdown-menu"
    });
    $staffMenu.append(menuItem(getAction("logout")), menuItem(getAction("dashboard")));
    let janitorActions = staffActions.filter((val)=>filterAction(val, 1));
    $staffMenu.append(menuItem("Janitorial", true));
    for (const action of janitorActions)$staffMenu.append(menuItem(action));
    if (rank >= 2) {
        let modActions = staffActions.filter((val)=>filterAction(val, 2));
        if (modActions.length > 0) $staffMenu.append(menuItem("Moderation", true));
        for (const action of modActions)$staffMenu.append(menuItem(action));
        getReports().then(updateReports);
    }
    if (rank == 3) {
        let adminActions = staffActions.filter((val)=>filterAction(val, 3));
        if (adminActions.length > 0) $staffMenu.append(menuItem("Administration", true));
        for (const action of adminActions)$staffMenu.append(menuItem(action));
    }
    createStaffButton();
}
function createStaffButton() {
    if ($staffBtn !== null || staffInfo.Rank == 0) return;
    $staffBtn = new (0, _topbar.TopBarButton)("Staff", ()=>{
        let exists = (0, _jqueryDefault.default)(document).find($staffMenu).length > 0;
        if (exists) $staffMenu.remove();
        else (0, _topbar.$topbar).after($staffMenu);
    });
}
function updateReports(reports) {
    ...
    $staffMenu.find("a").each((e, elem)=>{
        ...
        let $span = (0, _jqueryDefault.default)("<span/>").text(` (${reports.length})`).appendTo(elem);
        if (reports.length > 0) // make it bold and red if there are reports
        $span.css({
            "font-weight": "bold",
            "color": "red"
        });
...
},{"jquery":"HtqFp","./lightbox":"jncT6","./topbar":"cuSk6","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"2blxl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initSettings", ()=>initSettings);
/* global webroot, defaultStyle, styles */ var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _lightbox = require("./lightbox");
var _topbar = require("./topbar");
var _storage = require("./storage");
...
class Setting {
    ...
    getStorageValue() {
        return (0, _storage.getStorageVal)(this.key, this.defaultVal);
    }
    setStorageValue(newVal) {
        (0, _storage.setStorageVal)(this.key, newVal);
    }
    createElement(selector = "<input/>", props = {}) {
        return (0, _jqueryDefault.default)(selector).prop(props).prop({
            id: this.key,
            name: this.key
        });
    }
...
class DropdownSetting extends Setting {
    constructor(key, title, options = [], defaultVal = "", onSave = ()=>{}){
        ...
        for (const option of options)(0, _jqueryDefault.default)("<option/>").val(option.val).text(option.text).appendTo(this.element);
...
class NumberSetting extends Setting {
    getStorageValue() {
        ...
        if (isNaN(val)) val = this.defaultVal;
        return val;
    }
    constructor(key, title, defaultVal = 0, minMax = {
        min: null,
        max: null
    }, onSave = ()=>{}){
        super(key, title, defaultVal, onSave);
        ...
        if (typeof minMax.min == "number" && !isNaN(minMax.min)) props.min = minMax.min;
        if (typeof minMax.max == "number" && !isNaN(minMax.max)) props.max = minMax.max;
        this.element = this.createElement("<input />", props).val(this.getStorageValue());
    }
}
function createLightbox() {
    let settingsHTML = `<div id="settings-container" style="overflow:auto"><table width="100%"><colgroup><col span="1" width="50%"><col span="1" width="50%"></colgroup></table></div><div class="lightbox-footer"><hr /><button id="save-settings-button">Save Settings</button></div>`;
    (0, _lightbox.showLightBox)("Settings", settingsHTML);
    (0, _jqueryDefault.default)("button#save-settings-button").on("click", ()=>{
        settings.forEach((setting, key)=>{
            (0, _storage.setStorageVal)(key, setting.getElementValue());
            setting.onSave();
        });
    });
    let $settingsTable = (0, _jqueryDefault.default)("#settings-container table");
    settings.forEach((setting)=>{
        let $tr = (0, _jqueryDefault.default)("<tr/>").appendTo($settingsTable);
        (0, _jqueryDefault.default)("<td/>").append((0, _jqueryDefault.default)("<b/>").text(setting.title)).appendTo($tr);
        (0, _jqueryDefault.default)("<td/>").append(setting.element).appendTo($tr);
    });
}
function initSettings() {
    let styleOptions = [];
    for (const style of styles)styleOptions.push({
        text: style.Name,
        val: style.Filename
    });
    settings.set("style", new DropdownSetting("style", "Style", styleOptions, defaultStyle, function() {
        document.getElementById("theme").setAttribute("href", `${webroot}css/${this.getElementValue()}`);
    }));
    settings.set("pintopbar", new BooleanSetting("pintopbar", "Pin top bar", true, (0, _topbar.initTopBar)));
    settings.set("enableposthover", new BooleanSetting("enableposthover", "Preview post on hover", false, (0, _postutil.initPostPreviews)));
    settings.set("enablepostclick", new BooleanSetting("enablepostclick", "Preview post on click", true, (0, _postutil.initPostPreviews)));
    settings.set("useqr", new BooleanSetting("useqr", "Use Quick Reply box", true, (0, _qr.initQR)));
    ...
    if ($settingsButton === null) $settingsButton = new (0, _topbar.TopBarButton)("Settings", createLightbox);
}

},{"jquery":"HtqFp","./lightbox":"jncT6","./topbar":"cuSk6","./storage":"d8CBa","./postutil":"12NNr","./qr":"epotB","./watcher":"c0CZ6","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["hWzny"], "hWzny", "parcelRequire8c47")

//# sourceMappingURL=gochan.js.map
